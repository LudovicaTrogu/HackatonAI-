# Hackathon Agentic Coding — Temi della sfida

*Hagenthon · Accenture Application Engineering*

Scegliete uno dei tre temi, definite un problema specifico, costruite un prototipo e preparate la demo finale.

---

## Tema 01 · Accessibilità Digitale

**Obiettivo:** Usare strumenti di agentic coding per costruire qualcosa che aiuti davvero una persona con una disabilità, una fragilità o una difficoltà a usare un servizio digitale che oggi, da sola, non riesce a usare bene.
...
1. **Persona & Barriera** — Chi state aiutando, quale barriera incontra e in quale momento esatto del suo percorso si ferma.
2. **Percorso Assistito** — La demo del percorso completo: dal punto in cui la persona si bloccava fino al task portato a termine con il supporto della soluzione.
3. **Autonomia & Limiti** — Quanta autonomia guadagna la persona, cosa è stato semplificato senza alterarne il senso e quali limiti restano.
...
1. **User Difficulty Statement** — Quale difficoltà ha l'utente, in quale processo e perché è rilevante.
2. **Before / After Simplicity Evidence** — Un esempio di testo, flusso, schermata o istruzione resa più chiara.
3. **Risk & Clarity Note** — Cosa è stato semplificato, cosa non è stato alterato e come è stata evitata ambiguità.
...
**Obiettivo:** Usare strumenti di agentic coding per abbassare le barriere di accesso all'apprendimento digitale, aiutando persone che partono da una situazione di svantaggio.
...
1. **Learner Profile Statement** — Chi è l'utente target, quale difficoltà ha e in quale scenario.
2. **Adaptive Evidence** — Un esempio concreto di come la soluzione cambia in base al livello o al bisogno dell'utente.
3. **Learning Outcome Note** — Cosa l'utente sa fare alla fine che prima non sapeva fare, e come è stato verificato.
...
*Hagenthon · Accenture Application Engineering · generato il 14 settembre 2026*
